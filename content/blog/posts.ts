...
const BLOG_POSTS: BlogPost[] = [
  ...
  // 9. Récupération données disque dur Maroc
  {
    ...
    content: toHtml([
      ...
      "AlloSupport propose un <a href=\"/recuperation-donnees\" class=\"text-primary-600 hover:text-primary-700 underline\">service récupération données disque dur Maroc</a> avec tentative de récupération logicielle à distance. Pour la <a href=\"/recuperation-donnees-casablanca\" class=\"text-primary-600 hover:text-primary-700 underline\">récupération données Casablanca</a>, nous intervenons à distance. En urgence, consultez notre guide <a href=\"/blog/disque-dur-panne-que-faire-maroc\" class=\"text-primary-600 hover:text-primary-700 underline\">disque dur en panne que faire</a>. Pour un <a href=\"/depannage-informatique\" class=\"text-blue-600 font-bold hover:underline\">diagnostic panne disque dur</a>, contactez-nous. Si le disque est physiquement endommagé, orientation vers un partenaire labo. <a href=\"/blog/cybersecurite-pme-maroc-guide-2026\" class=\"text-primary-600 hover:text-primary-700 underline\">cybersécurité</a>, <a href=\"/devis\" class=\"text-primary-600 hover:text-primary-700 underline\">devis</a>, <a href=\"/contact\" class=\"text-primary-600 hover:text-primary-700 underline\">contact</a>.",
    ]),
  },

...
export const metadata: Metadata = {
  title: "Maintenance Informatique au Maroc - Parc PC & Serveurs | AlloSupport.ma",
  description:
    "Maintenance informatique pour particuliers exigeants et petites structures au Maroc : prévention pannes, mises à jour, sauvegardes et sécurité.",
  alternates: {
    canonical: "https://allosupport.ma/maintenance-informatique",
  },
  openGraph: {
    title: "Maintenance Informatique au Maroc",
    description:
      "Gardez vos PC et postes de travail en bonne santé grâce à une maintenance informatique régulière à distance.",
    url: "https://allosupport.ma/maintenance-informatique",
    type: "website",
  },
};
      ...
      <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white py-20">
        <div className="max-w-6xl mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
              Maintenance Informatique au Maroc
            </h1>
            <p className="text-lg text-slate-100 mb-6">
              Plutôt que d&apos;attendre la panne, mettez en place une{" "}
              <strong className="text-emerald-200">maintenance régulière</strong> pour vos
              PC et postes de travail : mises à jour, nettoyage, sauvegardes et vérifications.
            </p>
            <a
              href={`${whatsappBase}?text=${encodeURIComponent(
                "Bonjour, je veux mettre en place une maintenance informatique régulière."
              )}`}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white font-semibold px-6 py-3 rounded-xl shadow-lg transition"
            >
              Discuter d&apos;un plan de maintenance
            </a>
          </div>
        </div>
      </section>

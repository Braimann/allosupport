              ...
              <div className="overflow-x-auto rounded-lg border border-slate-200">
                <table className="w-full text-sm">
                  ...
                  <tbody className="text-slate-700">
                    <tr className="border-b border-slate-100 hover:bg-slate-50"><td className="p-3">Technicolor TD5130 V2</td><td className="p-3"><a href="http://192.168.1.1" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-mono">192.168.1.1</a></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">admin</code></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">admin</code></td><td className="p-3">2020-2024</td></tr>
                    <tr className="border-b border-slate-100 hover:bg-slate-50"><td className="p-3">Technicolor TG788vn</td><td className="p-3"><a href="http://192.168.1.1" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-mono">192.168.1.1</a></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">admin</code></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">admin</code></td><td className="p-3">2019-2022</td></tr>
                    <tr className="border-b border-slate-100 hover:bg-slate-50 bg-amber-50"><td className="p-3">Sagem F@ST 3304 V2</td><td className="p-3"><a href="http://192.168.1.1" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-mono">192.168.1.1</a></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">Menara</code></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">Menara</code></td><td className="p-3">2016-2019</td></tr>
                    <tr className="border-b border-slate-100 hover:bg-slate-50"><td className="p-3">ZTE ZXHN H108L</td><td className="p-3"><a href="http://192.168.1.1" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-mono">192.168.1.1</a></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">admin</code></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">admin</code></td><td className="p-3">2017-2021</td></tr>
                    <tr className="border-b border-slate-100 hover:bg-slate-50"><td className="p-3">ZTE ZXHN F680</td><td className="p-3"><a href="http://192.168.1.1" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-mono">192.168.1.1</a></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">admin</code></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">admin</code></td><td className="p-3">2020-2026</td></tr>
                    <tr className="border-b border-slate-100 hover:bg-slate-50"><td className="p-3">Huawei HG8245H</td><td className="p-3"><a href="http://192.168.1.1" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-mono">192.168.1.1</a></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">admin</code></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">admin</code></td><td className="p-3">2021-2026</td></tr>
                    <tr className="hover:bg-slate-50"><td className="p-3">Huawei HG8347R</td><td className="p-3"><a href="http://192.168.1.1" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-mono">192.168.1.1</a></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">admin</code></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">admin</code></td><td className="p-3">2022-2026</td></tr>
                  </tbody>
                </table>
              </div>
            </div>
            ...
            <div className="mb-10">
              ...
              <div className="overflow-x-auto rounded-lg border border-slate-200">
                <table className="w-full text-sm">
                  ...
                  <tbody className="text-slate-700">
                    <tr className="border-b border-slate-100 hover:bg-slate-50"><td className="p-3">Huawei HG8245H</td><td className="p-3"><a href="http://192.168.1.1" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-mono">192.168.1.1</a></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">admin</code></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">admin</code></td><td className="p-3">2019-2026</td></tr>
                    <tr className="border-b border-slate-100 hover:bg-slate-50"><td className="p-3">ZTE ZXHN H108N</td><td className="p-3"><a href="http://192.168.1.1" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-mono">192.168.1.1</a></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">admin</code></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">admin</code></td><td className="p-3">2018-2022</td></tr>
            ...
            <div className="mb-8">
              ...
              <div className="overflow-x-auto rounded-lg border border-slate-200">
                <table className="w-full text-sm">
                  ...
                  <tbody className="text-slate-700">
                    <tr className="border-b border-slate-100 hover:bg-slate-50"><td className="p-3">Flybox B612</td><td className="p-3"><a href="http://192.168.1.1" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-mono">192.168.1.1</a></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">admin</code></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">[étiquette]</code></td><td className="p-3">2020-2026</td></tr>
                    <tr className="border-b border-slate-100 hover:bg-slate-50"><td className="p-3">Flybox B525</td><td className="p-3"><a href="http://192.168.1.1" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-mono">192.168.1.1</a></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">admin</code></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">admin</code></td><td className="p-3">2018-2022</td></tr>
                    <tr className="border-b border-slate-100 hover:bg-slate-50"><td className="p-3">Flybox B310</td><td className="p-3"><a href="http://192.168.8.1" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-mono">192.168.8.1</a></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">admin</code></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">admin</code></td><td className="p-3">2019-2023</td></tr>
                    <tr className="hover:bg-slate-50"><td className="p-3">Huawei B535</td><td className="p-3"><a href="http://192.168.8.1" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-mono">192.168.8.1</a></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">admin</code></td><td className="p-3"><code className="bg-slate-100 px-2 py-1 rounded">admin</code></td><td className="p-3">2021-2026</td></tr>
                  </tbody>
                </table>
              </div>
            </div>

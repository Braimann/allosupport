...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: serviceContent.metadata.title,
    description: serviceContent.metadata.description,
    url: `${SITE_URL}/services/cybersecurite`,
    siteName: BRAND,
    type: "website",
    locale: "fr_MA",
...
export default function CybersecuritePage() {
  return (
    <ServiceDedicatedLayout
      ...
      slug="cybersecurite"
      whatsappMessage="Bonjour AlloSupport, je veux sécuriser mon entreprise contre les cyberattaques. Je souhaite un audit ou des recommandations."
      serviceNameForSchema="Audit Cybersécurité PME Maroc"
    />
  );
}
